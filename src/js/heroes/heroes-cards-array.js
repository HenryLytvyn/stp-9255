...
const heroesCards = [
  {
    title: 'General&nbsp;Kairos',
    description:
      'A fallen warlord known for brutal tactics and undying loyalty',
    images: {
      mobile1x: general_kairos_mobile,
      mobile2x: general_kairos_mobile_2x,
      desktop1x: general_kairos_desktop,
      desktop2x: general_kairos_desktop_2x,
    },
    alt: 'A heavily armored knight in a black robe',
  },

  {
    title: 'Lady An-Mei',
    description: 'A cunning diplomat skilled in espionage and poison',
    images: {
      mobile1x: lady_an_mobile,
      mobile2x: lady_an_mobile_2x,
      desktop1x: lady_an_desktop,
      desktop2x: lady_an_desktop_2x,
    },
    alt: 'anime girl',
  },

  {
    ...
    description: 'A cunning diplomat skilled in espionage and poison',
    images: {
      mobile1x: master_shen_mobile,
      mobile2x: master_shen_mobile_2x,
      desktop1x: master_shen_desktop,
      desktop2x: master_shen_desktop_2x,
    },
    alt: 'bald sensei',
  },

  {
    title: 'Prince Riku',
    description:
      'A noble warrior haunted by the betrayal that shattered his realm',
    images: {
      mobile1x: prince_riku_mobile,
      mobile2x: prince_riku_mobile_2x,
      desktop1x: prince_riku_desktop,
      desktop2x: prince_riku_desktop_2x,
    },
    alt: 'Yong prince in a dark blue robe',
  },

  {
    title: 'The Empress in Exile',
    description:
      'A noble warrior haunted by the betrayal that shattered his realm',
    images: {
      mobile1x: the_empress_mobile,
      mobile2x: the_empress_mobile_2x,
      desktop1x: the_empress_desktop,
      desktop2x: the_empress_desktop_2x,
    },
    alt: 'red-haired anime girl with a sword in her hand, wearing armor and a short skirt',
  },
];
