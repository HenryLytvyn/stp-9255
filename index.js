...
>
  ...
  >
    ...
    />
      ...
      </li>`).join("")}const k="features",r=document.querySelector('[data-id="features__cards-deck"]'),Le=document.querySelector('[data-id="features__open-cards"]');let _=!1,l=null;M();W(()=>M());function M(){if(l&&(r.removeEventListener("click",l),l=null),q())r.style.cursor="default",r.innerHTML=we(y);else{let e=[...y];const t=[];t.push(e[e.length-1]),e.pop(),Le.innerHTML=`${z(t)}`,x(),r.innerHTML=Y(e),l=function(){if(_)return;_=!0,r.style.cursor="default";const o=r.lastElementChild;o.classList.add("transition-anim"),setTimeout(()=>{o.style.right="-603px"},1e3),setTimeout(()=>{t.push(e[e.length-1]),e.pop(),e.unshift(t[0]),t.shift();const s=document.querySelector('[data-id="features__card-title"]'),a=document.querySelector('[data-id="features__card-text"]'),i=document.querySelector('[data-id="features__open-card-image"]');Ce(s,a),Se(t[0],s,a,i),$e(e[0],o),x(),setTimeout(()=>{Ee(s,a)},100),r.style.cursor="pointer",_=!1},2e3)},r.addEventListener("click",l)}}function x(){const e=document.querySelector('[data-anim="clip"]'),t=document.querySelector('[data-anim="border"]');e&&t&&(e.beginElement(),t.beginElement())}function Se({title:e,description:t,images:n},o,s,a){o.textContent=e,s.textContent=t,a.setAttribute("href",B(n))}function Ee(e,t){e.classList.add("open"),t.classList.add("open"),e.classList.remove("close"),t.classList.remove("close")}function Ce(e,t){e.classList.add("close"),t.classList.add("close"),e.classList.remove("open"),t.classList.remove("open")}function $e({images:e,alt:t},n){setTimeout(()=>{n.remove()},50),r.insertAdjacentHTML("afterbegin",`<li class="features__deck-item">
      ${m(e,t,k)}
