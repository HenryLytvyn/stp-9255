import{S as y}from"./assets/vendor-CRZmPYk3.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function o(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=o(s);fetch(s.href,i)}})();(()=>{const e=document.scrollingElement||document.documentElement;let t=0,o=0;const n=p=>p.preventDefault(),s=p=>{["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","PageUp","PageDown","Home","End"," ","Spacebar"].includes(p.key)&&p.preventDefault()},i=()=>window.scrollTo(t,o);function r(){t=e.scrollLeft,o=e.scrollTop,window.addEventListener("scroll",i,{passive:!1}),window.addEventListener("wheel",n,{passive:!1}),document.addEventListener("wheel",n,{passive:!1,capture:!0}),window.addEventListener("touchmove",n,{passive:!1}),document.addEventListener("touchmove",n,{passive:!1,capture:!0}),window.addEventListener("keydown",s,{passive:!1})}function C(){window.removeEventListener("scroll",i),window.removeEventListener("wheel",n),document.removeEventListener("wheel",n,{capture:!0}),window.removeEventListener("touchmove",n),document.removeEventListener("touchmove",n,{capture:!0}),window.removeEventListener("keydown",s)}window.lockScroll=r,window.unlockScroll=C})();const m=document.querySelector('[data-id="mobile-menu"]'),E=document.querySelector('[data-id="mobile-btn"]'),x=document.querySelector('[data-id="nav-icon"]'),$=document.querySelectorAll('[data-id="nav__item-link"]');document.querySelector("body");const w=document.querySelector('[data-id="mobile-menu__background"]'),B=document.querySelector('[data-id="header__logo"]');let k,u=!1;E.addEventListener("click",()=>{m.style.backgroundPosition="center top",x.classList.toggle("open"),m.classList.toggle("open"),w.classList.toggle("open"),u?(unlockScroll(),u=!1):(lockScroll(),u=!0),k=document.documentElement.scrollTop,A(Number(k))});$.forEach(e=>e.addEventListener("click",L));B.addEventListener("click",L);function L(){x.classList.remove("open"),m.classList.remove("open"),w.classList.remove("open"),unlockScroll()}function A(e){m.style.backgroundPosition=`center -${e}px`}const T=document.querySelectorAll('[data-id="title-frame-path"]'),S=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&(t.target.classList.add("animate"),S.unobserve(t.target))})},{threshold:.5});T.forEach(e=>{const t=e.getTotalLength();e.style.strokeDasharray=t,e.style.strokeDashoffset=t,S.observe(e)});const d=1200;function h(){return window.innerWidth<d}const q=`<svg width="288" height="450" viewBox="0 0 288 450">
  <defs>
...
>
  ...
  >
    ...
    />
        ...
        ${(h()?q:M).replaceAll("${cardSrc}",t.src).replaceAll("${id}",t.id)}
        </div>
    ...
    `).join("")}const he="/stp-9255/assets/general-kairos-mobile-D7GAxY08.png",ke="/stp-9255/assets/general-kairos-mobile@2x-MFWBAY1u.png",be="/stp-9255/assets/general-kairos-desktop-BjqaNA35.png",fe="/stp-9255/assets/general-kairos-desktop@2x-CxLhHi5N.png",ye="/stp-9255/assets/lady-an-may-mobile-BPMc0N6Q.png",xe="/stp-9255/assets/lady-an-may-mobile@2x-BB1B6RPL.png",we="/stp-9255/assets/lady-an-may-desktop-wuVrYL2y.png",Le="/stp-9255/assets/lady-an-may-desktop@2x-BayOmFME.png",Se="/stp-9255/assets/master-shen-mobile-BKbkMWhn.png",Ce="/stp-9255/assets/master-shen-mobile@2x-VRcrJC7c.png",Ee="/stp-9255/assets/master-shen-desktop-TZKarTUm.png",$e="/stp-9255/assets/master-shen-desktop@2x-BiLQGFbu.png",Be="/stp-9255/assets/prince-riku-mobile-JcTYtw8v.png",Ae="/stp-9255/assets/prince-riku-mobile@2x-TI4d2rqO.png",Te="/stp-9255/assets/prince-riku-desktop-tAvdkiv4.png",qe="/stp-9255/assets/prince-riku-desktop@2x-NZWFPiP2.png",Me="/stp-9255/assets/the-empress-mobile-BcFsZUb5.png",Pe="/stp-9255/assets/the-empress-mobile@2x-BLhNgvQB.png",De="/stp-9255/assets/the-empress-desktop-DITHj0IT.png",je="/stp-9255/assets/the-empress-desktop@2x-C7nTO3y_.png",Ie=[{title:"General&nbsp;Kairos",description:"A fallen warlord known for brutal tactics and undying loyalty",images:{mobile1x:he,mobile2x:ke,desktop1x:be,desktop2x:fe},alt:"A heavily armored knight in a black robe"},{title:"Lady An-Mei",description:"A cunning diplomat skilled in espionage and poison",images:{mobile1x:ye,mobile2x:xe,desktop1x:we,desktop2x:Le},alt:"anime girl"},{title:"Master Shen",description:"A cunning diplomat skilled in espionage and poison",images:{mobile1x:Se,mobile2x:Ce,desktop1x:Ee,desktop2x:$e},alt:"bald sensei"},{title:"Prince Riku",description:"A noble warrior haunted by the betrayal that shattered his realm",images:{mobile1x:Be,mobile2x:Ae,desktop1x:Te,desktop2x:qe},alt:"Yong prince in a dark blue robe"},{title:"The Empress in Exile",description:"A noble warrior haunted by the betrayal that shattered his realm",images:{mobile1x:Me,mobile2x:Pe,desktop1x:De,desktop2x:je},alt:"red-haired anime girl with a sword in her hand, wearing armor and a short skirt"}],Ne="heroes",He=document.querySelector('[data-id="heroes__cards-list"]'),Fe=document.querySelector('[data-id="heroes__prev-btn"]'),Re=document.querySelector('[data-id="heroes__next-btn"]'),Ke=document.querySelector('[data-id="heroes__swiper"]'),Oe=document.querySelector('[data-id="heroes__sw-pagin-container"]');He.insertAdjacentHTML("beforeend",ve(Ie));Ge();function Ge(){new y(Ke,{slidesPerView:1,spaceBetween:20,loop:!0,speed:500,navigation:{prevEl:Fe,nextEl:Re},pagination:{el:Oe},keyboard:{enabled:!0},breakpoints:{[d]:{slidesPerView:3,slidesPerGroup:1,spaceBetween:21}}})}function Ve(e){return e.map(({name:t,review:o,grade:n})=>`
      ...
      `).join("")}function We(e){let t="";for(let o=e;o>0;o-=1)t+=`<svg
              stroke-linejoin="round"
              stroke-linecap="round"
              viewBox="0 0 24 24"
              height="35"
