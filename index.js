import{S as v}from"./assets/vendor-CRZmPYk3.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function i(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=i(s);fetch(s.href,o)}})();const p=document.querySelector('[data-id="mobile-menu"]'),w=document.querySelector('[data-id="mobile-btn"]'),k=document.querySelector('[data-id="nav-icon"]'),C=document.querySelectorAll('[data-id="nav__item-link"]'),h=document.querySelector("body"),x=document.querySelector('[data-id="mobile-menu__background"]'),L=document.querySelector('[data-id="header__logo"]');let m;w.addEventListener("click",()=>{p.style.backgroundPosition="center top",k.classList.toggle("open"),p.classList.toggle("open"),x.classList.toggle("open"),h.classList.toggle("no-scroll"),m=document.documentElement.scrollTop,console.log("scroll: ",m),S(Number(m))});C.forEach(e=>e.addEventListener("click",f));L.addEventListener("click",f);function f(){k.classList.remove("open"),p.classList.remove("open"),x.classList.remove("open"),h.classList.remove("no-scroll")}function S(e){p.style.backgroundPosition=`center -${e}px`,console.log(e)}const $=document.querySelectorAll('[data-id="title-frame-path"]'),y=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&(t.target.classList.add("animate"),y.unobserve(t.target))})},{threshold:.5});$.forEach(e=>{const t=e.getTotalLength();e.style.strokeDasharray=t,e.style.strokeDashoffset=t,y.observe(e)});const d=1200;function u(){return window.innerWidth<d}const B=`<svg width="288" height="450" viewBox="0 0 288 450">
  <defs>
...
>
  ...
  >
    ...
    />
        ...
        ${(u()?B:T).replaceAll("${cardSrc}",t.src).replaceAll("${id}",t.id)}
        </div>
    ...
    `).join("")}const ge="/stp-9255/assets/general-kairos-mobile-D7GAxY08.png",ue="/stp-9255/assets/general-kairos-mobile@2x-MFWBAY1u.png",_e="/stp-9255/assets/general-kairos-desktop-BjqaNA35.png",be="/stp-9255/assets/general-kairos-desktop@2x-CxLhHi5N.png",ke="/stp-9255/assets/lady-an-may-mobile-BPMc0N6Q.png",he="/stp-9255/assets/lady-an-may-mobile@2x-BB1B6RPL.png",xe="/stp-9255/assets/lady-an-may-desktop-wuVrYL2y.png",fe="/stp-9255/assets/lady-an-may-desktop@2x-BayOmFME.png",ye="/stp-9255/assets/master-shen-mobile-BKbkMWhn.png",ve="/stp-9255/assets/master-shen-mobile@2x-VRcrJC7c.png",we="/stp-9255/assets/master-shen-desktop-TZKarTUm.png",Ce="/stp-9255/assets/master-shen-desktop@2x-BiLQGFbu.png",Le="/stp-9255/assets/prince-riku-mobile-JcTYtw8v.png",Se="/stp-9255/assets/prince-riku-mobile@2x-TI4d2rqO.png",$e="/stp-9255/assets/prince-riku-desktop-tAvdkiv4.png",Be="/stp-9255/assets/prince-riku-desktop@2x-NZWFPiP2.png",Te="/stp-9255/assets/the-empress-mobile-BcFsZUb5.png",qe="/stp-9255/assets/the-empress-mobile@2x-BLhNgvQB.png",Me="/stp-9255/assets/the-empress-desktop-DITHj0IT.png",Ae="/stp-9255/assets/the-empress-desktop@2x-C7nTO3y_.png",Pe=[{title:"General&nbsp;Kairos",description:"A fallen warlord known for brutal tactics and undying loyalty",images:{mobile1x:ge,mobile2x:ue,desktop1x:_e,desktop2x:be},alt:"A heavily armored knight in a black robe"},{title:"Lady An-Mei",description:"A cunning diplomat skilled in espionage and poison",images:{mobile1x:ke,mobile2x:he,desktop1x:xe,desktop2x:fe},alt:"anime girl"},{title:"Master Shen",description:"A cunning diplomat skilled in espionage and poison",images:{mobile1x:ye,mobile2x:ve,desktop1x:we,desktop2x:Ce},alt:"bald sensei"},{title:"Prince Riku",description:"A noble warrior haunted by the betrayal that shattered his realm",images:{mobile1x:Le,mobile2x:Se,desktop1x:$e,desktop2x:Be},alt:"Yong prince in a dark blue robe"},{title:"The Empress in Exile",description:"A noble warrior haunted by the betrayal that shattered his realm",images:{mobile1x:Te,mobile2x:qe,desktop1x:Me,desktop2x:Ae},alt:"red-haired anime girl with a sword in her hand, wearing armor and a short skirt"}],Ee="heroes",De=document.querySelector('[data-id="heroes__cards-list"]'),Ie=document.querySelector('[data-id="heroes__prev-btn"]'),je=document.querySelector('[data-id="heroes__next-btn"]'),Ne=document.querySelector('[data-id="heroes__swiper"]'),Fe=document.querySelector('[data-id="heroes__sw-pagin-container"]');document.querySelector('[data-id="heroes__sw-pagin-item"]');De.insertAdjacentHTML("beforeend",me(Pe));He();function He(){new v(Ne,{slidesPerView:1,spaceBetween:20,loop:!0,speed:500,navigation:{prevEl:Ie,nextEl:je},pagination:{el:Fe},keyboard:{enabled:!0},breakpoints:{[d]:{slidesPerView:3,slidesPerGroup:1,spaceBetween:21}}})}
